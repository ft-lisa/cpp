...
ClapTrap::ClapTrap (const ClapTrap& clap)
{
        ...
        std::cout << "ClapTrap " << _name << " is create with recopie" << std::endl;
...
ClapTrap& ClapTrap::operator=(const ClapTrap& clap)
{
        ...
        _ep = clap._ep;
        _damage = clap._damage;
        std::cout << "ClapTrap " << _name << " is create with operator =" << std::endl;
...
void ClapTrap::takeDamage(unsigned int amount)
{
        if (_pv > 0)
        {
                std::cout << "ClapTrap " << _name << " was hit and miss " << amount << " points of damage !" << std::endl;
                _pv -= amount;
        }
